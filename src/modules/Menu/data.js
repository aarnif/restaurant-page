export const classicPizzas = [
  ...
  },
  {
    ...
    ingredients: "Tomato sauce, mozzarella, mushrooms, ham, artichokes, olives",
    price: "€ 11.99",
  },
  {
    name: "Capricciosa",
...
export const meatPizzas = [
  ...
  {
    name: "Carne Mista",
    ingredients: "Tomato sauce, mozzarella, mixed meats (ham, salami, sausage)",
    price: "€ 12.99",
  },
  {
    name: "Tacchino",
...
export const drinks = [
  ...
  { name: "Espresso", type: "Strong and rich Italian coffee", price: "€ 1.99" },
  {
    name: "Cappuccino",
